...
test("Account exposes six synchronized administration areas", () => {
  ...
  assert.match(app, /APP_VERSION = "empresa-20260827-account-ticket-shop-v379"/);
  assert.match(html, /account-premium\.css\?v=account-navigation-v11-20260827/);
  assert.equal((html.match(/app\.js\?v=gos-brand-v362-20260826-account-ticket-shop-v379-20260827/g) || []).length, 2);
