...
test("la capa compacta se carga de ultima en el portal", () => {
  ...
  const compactIndex = html.indexOf("portal-compact-1200x700.css?v=portal-compact-v2-20260914");
...
test("las mascaras redondeadas no pueden recortar contenido autenticado", () => {
  ...
  assert.match(css, /#loginPanel,\s*[\s\S]*?#loginPanel \*\s*\{[\s\S]*?border-radius:\s*0 !important/);
