...
const PLAN_CATALOG = {
  ...
  [PLAN_CODES.STARTER]: {
    ...
    best_for: "Negocios que quieren empezar a medir ROI sin pagar herramientas costosas.",
    access_summary: "Portal basico con dashboard, campanas sencillas, leads, reportes y 500 QR al mes.",
  ...
  [PLAN_CODES.GROWTH]: {
    ...
    name: "Portal Growth",
    category: "subscription",
    monthly_price_cop: 179000,
    price_label: "$179.000 / mes",
    billing_period: "monthly",
    ...
    access_summary: "Portal completo para operar campanas, sedes, afiliados, reportes y 2.000 QR al mes.",
  ...
  [PLAN_CODES.PRO]: {
    ...
    category: "subscription",
    monthly_price_cop: 349000,
    price_label: "$349.000 / mes",
    billing_period: "monthly",
