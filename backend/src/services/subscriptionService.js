...
const PLAN_PRICING_NOTES = {
  STARTER: {
    ...
    pricing_note: "Crece activa la operacion inicial de Qori con graficas, leads recientes, campanas y maquina.",
  },
  GROWTH: {
    recommended_start_package: null,
    portal_access_fee_cop: MEDIUM_PORTAL_COP,
    pricing_note: "Escala habilita gestion avanzada con dashboard completo, fidelizacion, contactos, sales y agenda.",
  },
  PRO: {
    recommended_start_package: null,
    portal_access_fee_cop: PREMIUM_PORTAL_COP,
    pricing_note: "Expande habilita operacion completa con analitica predictiva, afiliados, premios y asistencia de marketing.",
  },
};
...
const PLAN_CATALOG = {
  ...
  [PLAN_CODES.STARTER]: {
    ...
    best_for: "Negocios que ya necesitan operar campanas, visualizar leads recientes y entender el comportamiento de redencion.",
    access_summary: "Operacion inicial con graficas, leads recientes, campanas y maquina.",
  ...
  [PLAN_CODES.GROWTH]: {
    ...
    recommended: true,
    best_for: "Negocios que necesitan mayor capacidad operativa, mas analitica, gestion de contactos, fidelizacion y control comercial.",
    access_summary: "Gestion avanzada con dashboard completo, fidelizacion, contactos, sales y agenda.",
  ...
  [PLAN_CODES.PRO]: {
    ...
    best_for: "Negocios con operacion comercial avanzada, multiples frentes de activacion, seguimiento de clientes, afiliados, premios y analitica predictiva.",
    access_summary: "Operacion completa con automatizacion comercial, analitica predictiva, afiliados y soporte de marketing.",
    ...
    included: [
      ...
      "Directorio de contactos",
      "Inventario de obsequios ilimitado",
      "Sales",
      "Agenda para programar tareas + Journey de Clientes",
      ...
      "Leadboard",
      "Asistencia de marketing para la integracion de Qori",
    ],
    not_included: [],
    qr_monthly_included: 0,
    features: {
