...
const PLAN_PRICING_NOTES = {
  STARTER: {
    comparable_prepaid_package: "QR300",
    prepaid_reference_cop: 69900,
    portal_access_fee_cop: 149000,
    pricing_note: "QR300 prepago sirve para validar codigos. Starter RMS agrega portal, dashboard basico, campanas y lectura inicial de ROI para negocios pequenos.",
  },
  GROWTH: {
    comparable_prepaid_package: "QR2000",
    prepaid_reference_cop: 289900,
    portal_access_fee_cop: 399000,
    pricing_note: "QR2000 prepago valida volumen. Growth RMS desbloquea el centro de comando completo: revenue, afiliados, Sales Tracker, sedes, Focus Mode e insights automaticos.",
  },
  PRO: {
    comparable_prepaid_package: "QRMAX",
    prepaid_reference_cop: 999900,
    portal_access_fee_cop: 899000,
    pricing_note: "QR10000 prepago cubre validacion masiva. Pro RMS convierte ese volumen en operacion comercial: equipos, sedes, API, reportes ejecutivos, exportaciones y afiliados a escala.",
  },
};
...
const PLAN_CATALOG = {
  ...
  [PLAN_CODES.STARTER]: {
    ...
    best_for: "Negocios pequenos que quieren dejar de operar QR a ciegas y empezar a medir campanas.",
    access_summary: "Entrada al RMS con dashboard basico, hasta 2 campanas, leads visibles y 300 QR al mes.",
    ...
    included: [
      ...
      "300 QR incluidos cada mes",
      "Estados QR y reporte simple por campana",
    ],
    not_included: [
      "Afiliados y fidelizacion",
      "Multiples sedes",
      "RMS Command Center avanzado",
      "Focus Mode completo, API y marca blanca",
    ],
    qr_monthly_included: 300,
    features: {
      qr_validator: true,
      qr_prepaid_purchase: true,
      qr_simple_generator: true,
  ...
  [PLAN_CODES.GROWTH]: {
    ...
    name: "Growth RMS",
    category: "subscription",
    monthly_price_cop: 399000,
    price_label: "$399.000 / mes",
    billing_period: "monthly",
    ...
    best_for: "Pymes con campanas recurrentes, referidos, ventas registradas y necesidad de saber que estrategia repetir.",
    access_summary: "RMS Command Center completo con revenue, Sales Tracker, afiliados, sedes, Focus Mode e insights. 2.000 QR al mes.",
    pricing_note: PLAN_PRICING_NOTES.GROWTH.pricing_note,
    included: [
      "RMS Command Center completo",
      ...
      "Historias de Revenue, MG Revenue Score y Focus Mode",
  ...
  [PLAN_CODES.PRO]: {
    ...
    access_summary: "RMS avanzado para operar equipos, sedes, API, reportes ejecutivos, afiliados masivos y 8.000 QR al mes.",
    pricing_note: PLAN_PRICING_NOTES.PRO.pricing_note,
    included: [
      "Todo lo incluido en Growth",
      "8.000 QR incluidos cada mes",
  ...
  [PLAN_CODES.GLOBAL]: {
    ...
    access_summary: "Plan Global por cotizacion: desde 25.000 QR mensuales, portal brandeable, afiliados por volumen, sedes, integraciones y soporte estrategico.",
    pricing_note: "Plan superior por cotizacion. Parte de 25.000 QR mensuales y se estructura segun volumen, sedes, usuarios, afiliados, marca, integraciones, soporte, SLA y nivel de acompanamiento.",
    included: [
      "Todo lo incluido en Pro",
      "25.000+ QR mensuales segun cotizacion",
