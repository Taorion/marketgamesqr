...
const PLAN_PRICING_NOTES = {
  ...
  PRO: {
    ...
    pricing_note: "Premium convierte MarketGamesQR en un sistema comercial completo con campanas, activaciones, agenda, afiliados y analitica avanzada.",
  },
};
...
const PLAN_CATALOG = {
  ...
  [PLAN_CODES.PRO]: {
    ...
    best_for: "Marcas que quieren usar MarketGamesQR como sistema comercial completo con campanas, activaciones, agenda, contactos, fidelizacion, referidos y analitica avanzada.",
    access_summary: "Plan para marcas que quieren usar MarketGamesQR como sistema comercial completo con campanas, activaciones, agenda, contactos, fidelizacion, referidos y analitica avanzada.",
