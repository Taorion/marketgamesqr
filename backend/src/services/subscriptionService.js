...
const PLAN_CATALOG = {
  ...
  [PLAN_CODES.DEMO_AUTO_3D]: {
    ...
    category: "subscription",
    monthly_price_cop: 500,
    display_currency: "COP",
    payment_currency: "COP",
    price_label: "COP 500 / cada 3 dias",
    ...
    pricing_note: "Plan demo interno: COP 500 por ciclo de 3 dias. No usar como plan comercial.",
    included: [
