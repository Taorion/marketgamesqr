...
const env = {
  ...
  appSessionVersion: process.env.APP_SESSION_VERSION || "portal-session-v1",
  enforceSessionVersion: process.env.ENFORCE_SESSION_VERSION === "true",
  ...
  contactMailFrom: process.env.CONTACT_MAIL_FROM || "Qori <no-reply@gosqori.com>",
  marketingMailFrom: process.env.MARKETING_MAIL_FROM || process.env.CONTACT_MAIL_FROM || "Qori <no-reply@gosqori.com>",
