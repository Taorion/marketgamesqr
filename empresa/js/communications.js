  ...
  async function save(event) {
    ...
    try {
      ...
      if (action === "SEND" && type === "WHATSAPP") {
        ...
        showFeedback(`Envío finalizado: ${sentCount} enviados, ${sent.results?.failed || 0} fallidos y ${sent.results?.skipped || 0} omitidos.${duplicateNote}`, sentCount ? "success" : "error", { title: sentCount ? "Comunicación enviada" : "No se enviaron correos" });
      }
      if (action === "PUBLISH") {
